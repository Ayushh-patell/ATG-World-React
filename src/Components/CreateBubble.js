...
const CreateBubble = () => {
  return (
    <div className=" d-block d-md-none position-fixed p-4 rounded-circle shadow" style={{bottom: "15px", right: "15px", background: "linear-gradient(180deg, #FF5C5C 0%, #F0568A 100%)"}}>
